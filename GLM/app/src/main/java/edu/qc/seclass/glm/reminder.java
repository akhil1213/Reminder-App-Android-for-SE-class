...
public class reminder extends AppCompatActivity implements TimePickerDialog.OnTimeSetListener, DatePickerDialog.OnDateSetListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //todo: mTextView loses its alarm text if user sets an alaram for a reminder , then tries updating that specific reminder.
        //if(getAlarmString()!=null)mTextView.setText(getAlarmString());
    ...
    //this is the case when the user is trying to update an alarm but the user won't know what time the alarm is set for
    private String getAlarmString(){
        return user.db.getAlarm(editDesc.getText().toString(), editType.getText().toString());
    }
